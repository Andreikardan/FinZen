...
const CollapseComponent = () => {
  ...
  const closeUserEditPanel = () => {
    setActivePanels((prev) => prev.filter((key) => key !== "1"));
  };
  ...
  return (
    <div className={styles.container}>
      <Collapse
        ...
        style={{ padding: '0px', maxWidth: "340px", minWidth: "340px" }}
      >
        ...
        <Panel header="Редактировать личные данные" key="1" style={{ backgroundColor: "white" }}>
          <UserEdit onSuccess={closeUserEditPanel} />
        </Panel>
        <Panel
          key="3"
          header={
